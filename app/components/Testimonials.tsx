import { YouTube } from "@/app/components/icons/Icons";

export function Testimonials() {
  return (
    <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        <YouTube className="mx-auto w-20 h-auto sm:w-28" />
        <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium">
          ...
          <span className="relative z-10 text-2xl">
            Syncly nos ahorra tiempo. Compartir reuniones es instantáneo y la
            interfaz es clara. Ideal para coordinar sin complicaciones.
          </span>
        </p>
